...
export default function TopProviders() {
  return (
    <div>
      <Link href="/slots/saglayici-pragmatic-play" className="block rounded-xl overflow-hidden cursor-pointer hover:scale-[1.005] active:scale-[0.99] transition-transform relative h-[95px]">
