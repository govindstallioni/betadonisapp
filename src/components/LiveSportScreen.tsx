          ...
          {hasChildren ? (
            ...
            <FavoriteStar
              ...
              item={{
                ...
                id: `sport-${t.id}`,
                title: t.name,
                subtitle: `${t.count} etkinlik`,
                emoji: t.flag,
                href: activeTab === 1 ? `/prematch/league?name=${encodeURIComponent(t.name)}` : `/live/matches?league=${encodeURIComponent(t.name)}&flag=${encodeURIComponent(t.flag)}`,
              }}
            />
          )}
        </div>
