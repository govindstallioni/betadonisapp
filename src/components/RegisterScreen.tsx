...
const socialProviders = [
  { name: 'Google', color: '#fff', border: true, icon: <svg width="20" height="20" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4" /><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" /><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05" /><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335" /></svg> },
  { name: 'X.com', color: '#1a1a1a', border: false, icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg> },
  { name: 'Discord', color: '#5865F2', border: false, icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.095 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.095 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" /></svg> },
  { name: 'MailRu', color: '#0E8FCF', border: false, icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4" /><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8" /></svg> },
  { name: 'Yandex', color: '#fc3f1d', border: false, icon: <span className="text-white font-bold text-[14px]">Y</span> },
  { name: 'OK', color: '#ee8208', border: false, icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><circle cx="12" cy="8" r="4" /><path d="M12 14c-3 0-5.5 1-5.5 3.5 0 0 2 2.5 5.5 2.5s5.5-2.5 5.5-2.5c0-2.5-2.5-3.5-5.5-3.5z" /></svg> },
  { name: 'Telegram', color: '#26a5e4', border: false, icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0h-.056zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg> },
  { name: 'Apple ID', color: '#1a1a1a', border: false, icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83z" /><path d="M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" /></svg> },
]
...
function CheckboxField({ label, checked }: { label: string; checked?: boolean }) {
  ...
  return (
    <button onClick={() => setIsChecked(!isChecked)} className="flex items-start gap-2.5 mt-2.5 text-left">
      <div className={`w-[18px] h-[18px] rounded-[4px] flex-shrink-0 mt-0.5 flex items-center justify-center transition-colors ${
        isChecked ? 'bg-[#0E8FCF]' : 'border-[1.5px] border-[#c0c8d4] bg-white'
      }`}>
        {isChecked && (
...
function LinkRow({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <button className="flex items-center gap-2.5 mt-2.5 hover:opacity-80 transition-opacity">
      <div className="w-7 h-7 rounded-lg bg-[#edf5ff] flex items-center justify-center flex-shrink-0">
        {icon}
      </div>
...
function OneClickForm({ onBack }: { onBack: () => void }) {
  return (
    <div className="max-w-[430px] mx-auto bg-bg min-h-screen relative flex flex-col">
      <Header title="Kayıt" subtitle="Tek Tıkla" onBack={onBack} />
      <div className="flex-1 overflow-y-auto px-4 pb-1.54">
...
function PhoneForm({ onBack }: { onBack: () => void }) {
  return (
    <div className="max-w-[430px] mx-auto bg-bg min-h-screen relative flex flex-col">
      <Header title="Kayıt" subtitle="Telefon ile" onBack={onBack} />
      <div className="flex-1 overflow-y-auto px-4 pb-1.54">
        <div className="rounded-2xl px-1 py-1 mt-3">
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-1.5 bg-white rounded-xl px-3 py-[2px] border border-[#e8ecf1] hover:border-[#0E8FCF] transition-colors">
            ...
            <div className="flex-1 bg-white rounded-xl px-3 py-[2px] border border-[#e8ecf1] focus-within:border-[#0E8FCF] focus-within:shadow-[0_0_0_3px_rgba(14,143,207,0.1)] transition-all">
              <input
                type="tel"
                placeholder="Telefon numarası *"
                className="w-full text-[12px] text-[#1a2332] py-[14px] bg-transparent outline-none placeholder-[#b0b8c4]"
              />
            </div>
          </div>
          <DropdownField label="Para Birimi" value="Türk Lirası (TRY)" required />
...
function EmailForm({ onBack }: { onBack: () => void }) {
  return (
    <div className="max-w-[430px] mx-auto bg-bg min-h-screen relative flex flex-col">
      <Header title="Kayıt" subtitle="E-posta ile" onBack={onBack} />
      <div className="flex-1 overflow-y-auto px-4 pb-1.54">
        <div className="rounded-2xl px-1 py-1 mt-3">
          <InputField label="Soyad" placeholder="Soyad *" required />
          <InputField label="Ad" placeholder="Ad *" required />
          <DropdownField label="Ülke" value="Türkiye" required />
          <DropdownField label="Bölge (varsa)" value="İstanbul" />
          <InputField placeholder="Şehir/İlçe (varsa)" />
          <DropdownField label="Doğum tarihi" value="" required />
          <DropdownField label="Para Birimi" value="Türk Lirası (TRY)" required />
          <InputField label="E-posta" placeholder="E-posta *" required />
          <div className="flex items-center gap-2 mt-2.5">
            <button className="flex items-center gap-1.5 bg-white rounded-xl px-3 py-[2px] border border-[#e8ecf1] hover:border-[#0E8FCF] transition-colors">
              <div className="py-[6px]">
                <span className="text-[9px] text-[#737B8C] font-medium block">Kod</span>
                <div className="flex items-center gap-1.5">
                  <span className="text-[14px]">🇹🇷</span>
                  <span className="text-[12px] text-[#1a2332] font-medium">+90</span>
                  {chevronDown}
          ...
          <div className="mt-2.5">
            <div className="flex items-center bg-white rounded-xl px-3 py-[2px] border border-[#e8ecf1] focus-within:border-[#0E8FCF] focus-within:shadow-[0_0_0_3px_rgba(14,143,207,0.1)] transition-all">
              <div className="flex-1 py-[6px]">
                <span className="text-[9px] text-[#737B8C] font-medium block">Şifre *</span>
                <input
                  type="password"
                  placeholder="Şifre *"
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#737B8C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0">
          ...
          <div className="mt-2.5">
            <div className="flex items-center bg-white rounded-xl px-3 py-[2px] border border-[#e8ecf1] focus-within:border-[#0E8FCF] focus-within:shadow-[0_0_0_3px_rgba(14,143,207,0.1)] transition-all">
              <div className="flex-1 py-[6px]">
                <span className="text-[9px] text-[#737B8C] font-medium block">Şifre tekrar *</span>
                <input
                  type="password"
        ...
        <LinkRow icon={docIcon} label="Şartlar ve Koşullar" />
        <LinkRow icon={docIcon} label="Gizlilik Politikası" />
        <CheckboxField label="Etkinlikler hakkında e-posta ile haber alın" />
        <CheckboxField label="Bahis sonuçları hakkında e-posta ile bildirim alın" />
        <CheckboxField label="18 yaşından büyük olduğumu ve şirketin şartlar ve koşullarını ve gizlilik politikasını okuduğumu ve kabul ettiğimi onaylıyorum." />
        <div className="flex items-center justify-center gap-1 mt-4">
          <span className="text-[11px] text-[#737B8C]">Zaten hesabınız var mı?</span>
          <Link href="/login" className="text-[11px] text-[#0E8FCF] font-medium">Giriş Yap</Link>
...
function SocialForm({ onBack }: { onBack: () => void }) {
  return (
    <div className="max-w-[430px] mx-auto bg-bg min-h-screen relative flex flex-col">
      <Header title="Kayıt" subtitle="Sosyal Medya ile" onBack={onBack} />
      <div className="flex-1 overflow-y-auto px-4 pb-1.54">
        ...
        <div className="flex flex-wrap gap-1.5 mt-3">
          {socialProviders.map((p) => (
            <button
              key={p.name}
              className={`flex flex-col items-center gap-0.5 w-[44px] py-1 rounded-md ${p.border ? 'bg-white border border-[#e8ecf1]' : ''}`}
              style={!p.border ? { backgroundColor: p.color } : undefined}
            >
              <div className="w-5 h-5 flex items-center justify-center [&>svg]:w-[14px] [&>svg]:h-[14px]">{p.icon}</div>
              <span className={`text-[6px] font-medium leading-none ${p.border ? 'text-[#1a2332]' : 'text-white'}`}>{p.name}</span>
            </button>
          ))}
        </div>
...
function BottomButton() {
  return (
    <div className="sticky bottom-0 px-4 py-2 bg-bg">
      <button className="w-full py-[12px] bg-[#27ae60] text-white text-[13px] font-medium rounded-xl hover:bg-[#219a52] transition-colors">
        Kayıt Ol
      </button>
    </div>
  )
...
export default function RegisterScreen() {
  ...
  if (activeMethod === 0) return <OneClickForm onBack={() => setActiveMethod(null)} />
  if (activeMethod === 1) return <PhoneForm onBack={() => setActiveMethod(null)} />
  if (activeMethod === 2) return <EmailForm onBack={() => setActiveMethod(null)} />
  if (activeMethod === 3) return <SocialForm onBack={() => setActiveMethod(null)} />
    ...
    <div className="max-w-[430px] mx-auto bg-bg min-h-screen relative flex flex-col">
      ...
      <div className="relative h-[240px] bg-[#dce8f5] overflow-hidden">
        ...
        <svg viewBox="0 0 430 320" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
          ...
          <polygon points="140,0 170,50 130,80 90,50 110,0" stroke="#c8d4de" strokeWidth="2" fill="none" opacity="0.5" />
          <polygon points="140,130 190,100 200,150 170,190 110,190 100,150" stroke="#c8d4de" strokeWidth="2" fill="none" opacity="0.4" />
          <polygon points="250,70 280,110 260,150 230,130" stroke="#c8d4de" strokeWidth="2" fill="none" opacity="0.3" />

          {/* Basketball - top right */}
          <circle cx="370" cy="140" r="110" fill="#f0a030" opacity="0.8" />
          <circle cx="370" cy="140" r="105" fill="#e89520" opacity="0.6" />
          <path d="M265,140 Q370,90 475,140" stroke="#d08018" strokeWidth="2" fill="none" opacity="0.4" />
          <path d="M265,140 Q370,190 475,140" stroke="#d08018" strokeWidth="2" fill="none" opacity="0.4" />
          <line x1="370" y1="35" x2="370" y2="245" stroke="#d08018" strokeWidth="2" opacity="0.3" />

          {/* Tennis ball - center bottom */}
          <circle cx="280" cy="320" r="55" fill="#a4e34a" />
          <circle cx="280" cy="320" r="52" fill="#8fd630" />
          <path d="M240,285 Q280,320 240,355" stroke="white" strokeWidth="2.5" fill="none" opacity="0.5" />
          <path d="M320,285 Q280,320 320,355" stroke="white" strokeWidth="2.5" fill="none" opacity="0.5" />
        </svg>
      </div>
        ...
        <div className="flex flex-col gap-2 mt-4">
          {regMethods.map((method, i) => (
            <button
              ...
              className="flex items-center gap-3 bg-white rounded-xl px-3 py-[10px] border border-[#e8ecf1] hover:shadow-md transition-shadow"
            >
