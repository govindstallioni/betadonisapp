...
const sporPool = [
  ...
  { game: 'PSG - Bayern Münih',       image: '/events/french-league.png',    amount: 0 },
  { game: 'Fenerbahçe - Trabzonspor', image: '/events/turkey-league.png',    amount: 320.00 },
  { game: 'Liverpool - Chelsea',      image: '/events/europa-league.png',    amount: 0 },
  { game: 'Inter - Juventus',         image: '/events/italy-series-a.png',   amount: 560.00 },
...
export default function EnsonKazananlar() {
  ...
  // Start empty so server and client render identically; random data is
