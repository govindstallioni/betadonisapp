...
const hesapItems = [
<<<<<<< HEAD
  { title: 'Hesaba Para Yatır', href: '/kupon/deposit', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0E8FCF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="M2 10h20" /><path d="M12 14h4" /></svg> },
  { title: 'Hesabına Para Çek', href: '/kupon/withdraw', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0E8FCF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v10M12 12l4-4M12 12l-4-4" /><rect x="2" y="14" width="20" height="8" rx="2" /></svg> },
]
...
const ekstraItems = [
<<<<<<< HEAD
  { title: 'Proxy Ayarları', href: '/settings/proxy', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="#0E8FCF"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" /></svg> },
]

const hakkindaItems = [
  { title: 'Uygulamayı Paylaş', href: '/settings/about', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="#0E8FCF"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z" /></svg> },
  { title: 'Uygulamayı QR Kodu ile Paylaşın', href: '/settings/about', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="#0E8FCF"><path d="M3 11h8V3H3v8zm2-6h4v4H5V5zM3 21h8v-8H3v8zm2-6h4v4H5v-4zM13 3v8h8V3h-8zm6 6h-4V5h4v4zM13 13h2v2h-2zM15 15h2v2h-2zM13 17h2v2h-2zM17 13h2v2h-2zM19 15h2v2h-2zM17 17h2v2h-2zM19 19h2v2h-2zM15 19h2v2h-2z" /></svg> },
  { title: 'Uygulama Sürümü', desc: 'Güncellendi', href: '/settings/about', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="#27ae60"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" /></svg> },
  { title: 'Önbelleği Temizle', desc: '96.1 MB', href: 'cache', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="#737B8C"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" /></svg> },
=======
...
<<<<<<< HEAD
  const handleRow = (href: string) => {
    if (href === 'cache') {
      setCacheToast(true)
      setTimeout(() => setCacheToast(false), 2200)
    } else {
      router.push(href)
    }
  }
...
<<<<<<< HEAD
            <SettingsRow key={item.title} title={item.title} icon={item.icon} onClick={() => handleRow(item.href)} last={i === hesapItems.length - 1} />
=======
...
<<<<<<< HEAD
          ...
          <SettingsRow
            ...
            desc="Gol, korner, penaltı ve maç olayları"
            icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="#0E8FCF"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" /></svg>}
...
<<<<<<< HEAD
            <SettingsRow key={item.title} title={item.title} icon={item.icon} onClick={() => handleRow(item.href)} last={i === ekstraItems.length - 1} />
=======
...
<<<<<<< HEAD
            <SettingsRow key={item.title} title={item.title} desc={item.desc} icon={item.icon} onClick={() => handleRow(item.href)} last={i === hakkindaItems.length - 1} />
          ))}
        </SettingsCard>
      </div>
