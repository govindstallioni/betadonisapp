// Moved out of page.tsx unchanged: a 'use client' file cannot export
// generateStaticParams, which output: 'export' requires for this route.
'use client'
...
export default function BilgiClient() {
